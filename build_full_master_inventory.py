...
master_inventory = [
    # 00_Continuing_Issues
    {
        ...
        "whyThisMayBeAsked": "Crucial national security issue covering Indus Waters Treaty 1960, LoC, and FATF terrorism monitoring.",
        "whatHappened": "Bilateral review of Indus Waters Treaty implementation and cross-border security monitoring along the Line of Control.",
        "background": "Origins from 1947 partition, 1960 IWT, 1972 Simla Agreement, and 1999 Lahore Declaration.",
        "timeline": [
            {"date": "1960", "event": "Indus Waters Treaty signed in Karachi mediated by World Bank."},
            {"date": "1972", "event": "Simla Agreement establishes Line of Control."},
            {"date": "1999", "event": "Lahore Declaration signed for nuclear risk reduction."}
        ],
        "keyPeopleAndOrgs": ["MEA India", "Indus Water Commission", "FATF (Paris)", "UN Security Council"],
        ...
        "geoCard": {"location": "Indus River Basin & LoC", "capital": "New Delhi / Islamabad", "significance": "Strategic water source and border zone."},
        "confusionTraps": {"frequentlyConfusedWith": "Tashkent (1966) vs Simla (1972)", "whyTheyDiffer": "Tashkent ended 1965 war; Simla established LoC after 1971 war.", "memoryClue": "Simla = 1971 LoC."},
        ...
        "clatQuestions": [
            {"questionText": "Which international institution mediated the 1960 Indus Waters Treaty?", "options": ["IMF", "World Bank", "ADB", "UNDP"], "correctAnswer": "B", "explanation": "The World Bank mediated the IWT signed in Karachi in 1960."}
        ],
        "ailetMcqs": [
            {"questionText": "Which agreement established the Line of Control (LoC) in 1972?", "options": ["Tashkent", "Simla", "Lahore", "Agra"], "correctAnswer": "B", "explanation": "Simla Agreement 1972 converted ceasefire line into LoC."}
        ],
        "qcards": [{"front": "Which rivers were assigned to India under 1960 IWT?", "back": "Ravi, Beas, and Sutlej."}],
        "onePager": {"summary": "Indus Waters Treaty 1960 divides 6 rivers under World Bank mediation.", "traps": ["Don't confuse Tashkent 1966 with Simla 1972."], "mnemonic": "Eastern = RBS | Western = IJC."}
    },
    {
        ...
        "continuingIssue": True, "examYear": "CLAT/AILET 2027",
        "whyThisMayBeAsked": "ICJ advisory jurisdiction, Genocide Convention, Fourth Geneva Convention, India recognition in 1988.",
        "whatHappened": "ICJ proceedings regarding Gaza humanitarian crisis and legal consequences of prolonged occupation.",
        ...
        "keyPeopleAndOrgs": ["ICJ (The Hague)", "ICC (The Hague)", "UNSC", "Palestinian Authority"],
        "legalSignificance": "1948 Genocide Convention enforcement, Fourth Geneva Convention protection of civilians.",
        "staticGkConnection": "ICJ seat: Peace Palace, The Hague. 15 judges elected for 9-year terms.",
        "geoCard": {"location": "Gaza Strip & West Bank", "capital": "Jerusalem / Ramallah", "significance": "Levant conflict zone."},
        "confusionTraps": {"frequentlyConfusedWith": "ICJ vs ICC", "whyTheyDiffer": "ICJ is for States; ICC prosecutes Individuals.", "memoryClue": "ICJ = Judicial States | ICC = Individual Criminals."},
        ...
        "clatQuestions": [
            {"questionText": "Where is the ICJ headquartered?", "options": ["Geneva", "The Hague", "New York", "Vienna"], "correctAnswer": "B", "explanation": "ICJ is located at Peace Palace in The Hague, Netherlands."}
        ],
        "ailetMcqs": [
            {"questionText": "In which year did India recognize the State of Palestine?", "options": ["1947", "1971", "1988", "1993"], "correctAnswer": "C", "explanation": "India formally recognized Palestine in 1988."}
        ],
        "qcards": [{"front": "How many judges serve on the ICJ?", "back": "15 judges serving 9-year terms."}],
        "onePager": {"summary": "ICJ at The Hague handles Gaza cases under 1948 Genocide Convention.", "traps": ["ICJ is for States, ICC for individuals."], "mnemonic": "ICJ = 15 Judges | 9 Year Terms | Peace Palace."}
    },
    {
        ...
        "category": "International relations", "subcategory": "geopolitics & nuclear treaties", "importanceScore": 94,
        "continuingIssue": True, "examYear": "CLAT/AILET 2027",
        "whyThisMayBeAsked": "Key energy security topic touching Strait of Hormuz oil chokepoint, IAEA inspections, and JCPOA.",
        "whatHappened": "Geopolitical tension in West Asia affecting Strait of Hormuz maritime traffic and oil price volatility.",
        "background": "1979 Iranian Revolution, 2015 JCPOA nuclear deal, IAEA safeguards.",
        "timeline": [
        ...
        "legalSignificance": "Treaty on Non-Proliferation of Nuclear Weapons (NPT), UNCLOS innocent passage in straits.",
        "staticGkConnection": "Strait of Hormuz connects Persian Gulf to Gulf of Oman. IAEA HQ: Vienna, Austria.",
        "geoCard": {"location": "Strait of Hormuz & Persian Gulf", "capital": "Tehran / Washington / Tel Aviv", "significance": "Global oil transport chokepoint carrying 20% of world petroleum."},
        ...
        "clatPassage": "The ongoing confrontation involving Iran, Israel, and the United States carries profound implications for global energy security and international maritime law. The Strait of Hormuz, a narrow waterway connecting the Persian Gulf to the Gulf of Oman, handles approximately 20% of global petroleum consumption. Any maritime disruption directly triggers oil price spikes, impacting India's macroeconomic stability and import bill. From a legal standpoint, the status of Iran's nuclear program remains under the oversight of the International Atomic Energy Agency (IAEA) under NPT safeguards.",
        "clatQuestions": [
            {"questionText": "Which body of water does the Strait of Hormuz directly connect to the Gulf of Oman?", "options": ["Red Sea", "Persian Gulf", "Black Sea", "Arabian Sea"], "correctAnswer": "B", "explanation": "Strait of Hormuz connects the Persian Gulf to the Gulf of Oman."}
        ],
        "ailetMcqs": [
            {"questionText": "Where is the International Atomic Energy Agency (IAEA) headquartered?", "options": ["Geneva", "Vienna", "Paris", "New York"], "correctAnswer": "B", "explanation": "IAEA is headquartered in Vienna, Austria."}
        ],
        "qcards": [{"front": "What percentage of world petroleum passes through Strait of Hormuz?", "back": "Approximately 20% of world petroleum consumption."}],
    ...
    },
    {
        ...
        "continuingIssue": True, "examYear": "CLAT/AILET 2027",
        "whyThisMayBeAsked": "NATO Article 5, Black Sea Grain Initiative, UNSC veto, and India's strategic autonomy policy.",
        ...
        "timeline": [
            ...
            {"date": "2014", "event": "Crimea annexed by Russia."}
        ],
        "keyPeopleAndOrgs": ["NATO (Brussels)", "UN Security Council", "European Union"],
        "legalSignificance": "UN Charter Article 2(4) prohibition on use of force, Geneva Conventions, SWIFT banking sanctions.",
        "staticGkConnection": "NATO HQ: Brussels, Belgium. Current member count: 32 nations (Sweden joined as 32nd).",
        ...
        "clatPassage": "The conflict between Russia and Ukraine has fundamentally reshaped the post-Cold War security order in Europe. The North Atlantic Treaty Organization (NATO), established in 1949 with its headquarters in Brussels, expanded to 32 members following the accession of Finland and Sweden. At the core of NATO is Article 5, which enshrines collective defense: an attack against one member is considered an attack against all. The conflict has also tested the functioning of the United Nations Security Council, where Russia holds permanent veto power under Article 27 of the UN Charter.",
        "clatQuestions": [
            {"questionText": "Which country recently joined NATO as its 32nd member state?", "options": ["Finland", "Sweden", "Ukraine", "Georgia"], "correctAnswer": "B", "explanation": "Sweden formally joined NATO in 2024 as its 32nd member state."}
        ],
        "ailetMcqs": [
        ...
        "onePager": {"summary": "Russia-Ukraine war highlights NATO Article 5 collective defense & UNSC veto mechanics.", "traps": ["Sweden is the 32nd NATO member, Finland was 31st."], "mnemonic": "NATO = 32 Members | HQ Brussels | Art 5 Defense."}
    },
    {
        ...
        "continuingIssue": True, "examYear": "CLAT/AILET 2027",
        "whyThisMayBeAsked": "Covers Waqf Act 1995 amendments, Articles 14, 25, 26, 300A, and Central Waqf Council.",
        ...
        "timeline": [
            {"date": "1995", "event": "Waqf Act 1995 enacted to unify property administration."},
            {"date": "2024", "event": "Waqf (Amendment) Bill introduced in Parliament."}
        ],
        ...
        "geoCard": {"location": "Pan-India Waqf Properties", "capital": "New Delhi", "significance": "Third-largest land holding category in India after Railways and Defence."},
        ...
        "clatPassage": "The administration of Waqf properties in India sits at the intersection of religious freedoms, property law, and secular state governance. Under Article 26 of the Constitution, religious denominations enjoy the right to establish and maintain institutions for religious and charitable purposes and manage their own affairs in matters of religion. However, property management remains subject to state regulation under public order, morality, and health. The Waqf Act 1995 established State Waqf Boards and the Central Waqf Council as statutory bodies to oversee dedicated properties. Following the 44th Constitutional Amendment of 1978, the right to property ceased to be a Fundamental Right under Article 31 and became a constitutional right under Article 300A.",
        "clatQuestions": [
            {"questionText": "Which constitutional amendment removed the right to property from Fundamental Rights?", "options": ["42nd Amendment", "44th Amendment", "86th Amendment", "103rd Amendment"], "correctAnswer": "B", "explanation": "The 44th Amendment Act (1978) deleted Article 31 and inserted Article 300A."}
        ],
        "ailetMcqs": [
            {"questionText": "Which Article of the Constitution guarantees the freedom to manage religious affairs?", "options": ["Article 25", "Article 26", "Article 29", "Article 30"], "correctAnswer": "B", "explanation": "Article 26 guarantees freedom to manage religious affairs."}
        ],
        "qcards": [{"front": "Under which Article is Right to Property currently protected?", "back": "Article 300A (Constitutional Right)."}],
        "onePager": {"summary": "Waqf governance involves Articles 25, 26, 300A and Central Waqf Council statutory powers.", "traps": ["Property is no longer a Fundamental Right under Art 31."], "mnemonic": "Art 26 = Manage Religious Affairs | Art 300A = Property Right."}
    },
    {
        ...
        "continuingIssue": True, "examYear": "CLAT/AILET 2027",
        "whyThisMayBeAsked": "Articles 200 & 201, pocket veto judicial scrutiny, landmark SC rulings in Punjab/Kerala state petitions.",
        ...
        "clatPassage": "The constitutional office of the Governor has been central to ongoing federal litigation regarding the legislative process. Under Article 200 of the Constitution, when a Bill passed by the State Legislative Assembly is presented to the Governor, the Governor has four options: grant assent, withhold assent, reserve the Bill for the consideration of the President, or return the Bill (if not a Money Bill) with a message requesting reconsideration. In a landmark clarification, the Supreme Court held that if the Assembly repasses the Bill with or without amendment, the Governor is constitutionally obligated to grant assent and cannot exercise a pocket veto.",
        "clatQuestions": [
            {"questionText": "Under Article 200, can a Governor withhold assent a second time after a Bill is repassed by the State Assembly?", "options": ["Yes, unconditionally", "No, assent becomes mandatory", "Only with Supreme Court permission", "Only for Money Bills"], "correctAnswer": "B", "explanation": "The proviso to Article 200 makes assent mandatory once a returned Bill is repassed by the House."}
        ],
        "ailetMcqs": [
            {"questionText": "Which Article governs reservation of State Bills for Presidential consideration?", "options": ["Article 200", "Article 201", "Article 213", "Article 245"], "correctAnswer": "B", "explanation": "Article 201 deals with Bills reserved by the Governor for Presidential consideration."}
        ],
